...
\begin{document}
    ...
    % ----- Control problem ----- %
    \input{sections/1_control_problem.tex}
    
    % ----- State-space representation ----- %
    \input{sections/2_state_space_representation.tex}
    
    % ----- Controller in time domain ----- %
    \input{sections/3_controller_time_domain.tex}
    
    % ----- Controller in frequency domain ----- %
    \input{sections/4_controller_frequency_domain.tex}
